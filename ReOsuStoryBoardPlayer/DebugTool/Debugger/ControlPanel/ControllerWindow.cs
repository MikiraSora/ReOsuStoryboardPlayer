...
namespace ReOsuStoryBoardPlayer.DebugTool.Debugger.ControlPanel
{
    public partial class ControllerWindow : Form
    {
        ...
        public void UpdateInfo()
        {
            ...
            progressBar1.Value = (int)Math.Max(progressBar1.Minimum, Math.Min(MusicPlayerManager.ActivityPlayer.CurrentTime*1.0f/MusicPlayerManager.ActivityPlayer.Length*progressBar1.Maximum, progressBar1.Maximum));
